...
# 
api_key="8b5b9b0f2a634607b894e71ab178bfd61768130874" 			#api_key
api_token="3b483f0cffc14dce333fe247bf0b0937948061362" 	#api_token
url="http://192.168.72.21:4999/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
